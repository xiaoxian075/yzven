...
public class Swagger2OperationImplicitParameterPlugin implements OperationBuilderPlugin {
    ...
    static Parameter implicitParameter(com.at.frame.annotation.ApiImplicitParam param) {
    ...
    private static ModelRef maybeGetModelRef(com.at.frame.annotation.ApiImplicitParam param) {
    ...
    private List<Parameter> readParameters(OperationContext context) {
        ...
        if (annotation.isPresent()) {
            parameters.add(Swagger2OperationImplicitParameterPlugin.implicitParameter(annotation.get()));
        }
        return parameters;
    }
