...
import com.at.entity.VenAdminCriteria.Criteria;
import com.at.entity.VenAdminCriteria.Criterion;
import com.at.entity.VenAdminCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class VenAdminSqlProvider {

    public String countByExample(VenAdminCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("ven_admin");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(VenAdminCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("ven_admin");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(VenAdmin record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("ven_admin");
    ...
    public String selectByExample(VenAdminCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        VenAdmin record = (VenAdmin) parameter.get("record");
        VenAdminCriteria example = (VenAdminCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("ven_admin");
    ...
    public String updateByPrimaryKeySelective(VenAdmin record) {
        SQL sql = new SQL();
        sql.UPDATE("ven_admin");
    ...
    protected void applyWhere(SQL sql, VenAdminCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
